...
//template.config('closeTag', '}}*/');
  ...
  gulp.task('tpl-load-nav-images', function () {
    return getImage(`./src/images/nav.png`).then(function (res) {
      MODS_CONFIG.navigators = [{image: res}];
    });
  });
  ...
  gulp.task('tpl-render', ['tpl-load-module-images', 'tpl-load-nav-images'], function () {
